...
public class Main {
    ...
    public static void liveCurrencyConvertor() throws IOException {
        ...
        System.out.println("Enter the country currency code conversion from");
        String source = scanner.next();
        System.out.println("Enter the country currency code conversion To");
    ...
    public static BigDecimal fetchingCurrencyData(String convertFrom, String convertTo) throws IOException {
        ...
        try {
            ...
            System.out.println("Please wait your data is adding.....");
            HttpGet get = new HttpGet(BASE_URL + source + ENDPOINT);
            ...
            System.out.println("please enter the correct country code if you don't know, you can check it at option 5");
        }
        return value;
    }
    ...
    public static void addFavoriteCurrency() throws IOException {
        ...
        System.out.println("Enter the Currency you want to add in favorite");
        String currencyConversionFromName = scanner.next();
        System.out.println("Enter the currency you want to convert it");
    ...
    public static void main(String args[]) throws IOException {
        ...
        while (true) {
            ...
            System.out.println("3. View Your Favorite Currency");
            System.out.println("4. For any update in currency values!!!");
